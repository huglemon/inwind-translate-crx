---
title: Installation
description: A comprehensive guide to using the inWind Translate browser extension for immersive language learning
icon: Wrench
---
...
Install inWind Translate from the store.
...
Currently, inWind Translate is available on the [Chrome Web Store](https://chromewebstore.google.com/detail/read-frog/modkelfkcfjpgbfmnbnllalkiogfofhb?utm_source=official) and [Microsoft Edge Add-ons](https://microsoftedge.microsoft.com/addons/detail/read-frog-open-source-a/cbcbomlgikfbdnoaohcjfledcoklcjbo).
...
The API key is like the key for you to call AI models in the inWind Translate. Please refer to [this page](/tutorial/api-key) for setting up the API key.
