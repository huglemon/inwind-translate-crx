...
export const metadata: Metadata = {
  ...
  description: `Read our privacy policy for using ${APP_NAME}.`,
}
...
export default function Privacy() {
  return (
    <article className="prose mx-auto max-w-3xl px-16 pb-8 pt-22">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            {' '}
            is any information that relates to an
      ...
      <ul>
        <li>
          <p>By email: contact@mengxi.work</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:
            {' '}
            <a href="https://readfrog.app" rel="noreferrer noopener" target="_blank">
              https://readfrog.app
            </a>
          </p>
        </li>
